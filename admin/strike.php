    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8">
                    <p style="text-align:center; font-size:150%; font-weight:bolder; font-style:italic;">Увольнение</p>
                    <p style="text-align:left; font-size:100%; font-weight:bolder;">Перед тем, как уволить сотрудника, нужно мотивировать своё решение в данной форме. Бывший сотрудник получит письмо с этой причиной, всё переосмыслит и смирится с грустным положением дел =(</p>
                    <div style="border: 1px gray solid; border-radius:10px;">
                        <form method="POST" action="letter.php" class="form-horizontal" style="margin: 1%;">
                            ...
                            <div class="row text-center">
                                <div class="col-md-2"></div>
                                <div class="col-md-4">
                                    <input type="submit" class="btn btn-danger" value="Уволить" name="submit"/> 
                                </div>
                                <div class="col-md-3">
        ...
        <?php
            if(isset($_POST['submit'])){
                ...
                $query = mysqli_query($connection, "DELETE FROM TeacherProfile WHERE TeacherID = $id ;");
                $_query = mysqli_query($connection, "DELETE FROM Users WHERE ID = $id ;");
